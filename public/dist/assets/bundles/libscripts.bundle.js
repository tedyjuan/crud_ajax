!(function (e, t) {
	...
	var h = (function (n) {
		...
		try {
			L.apply((t = I.call(d.childNodes)), d.childNodes),
			...
			if (!i && (E(t), (t = t || x), T)) {
				...
				if (
					...
					if (((c = e), (f = t), 1 === d && ($.test(e) || Q.test(e)))) {
						for (
							((f = (ee.test(e) && ve(t.parentNode)) || t) === t && h.scope) ||
								((a = t.getAttribute("id"))
									? (a = a.replace(ie, re))
			...
			function (e) {
				...
				return (
					i != x &&
						...
						(h.getElementsByClassName = J.test(x.getElementsByClassName)),
						...
						(a = []),
						(g = []),
						(h.qsa = J.test(x.querySelectorAll)) &&
							(ce(function (e) {
								var t;
							...
							? function (e, t) {
									...
									return (
										...
										(!h.sortDetached && t.compareDocumentPosition(e) === n)
											? e == x || (e.ownerDocument == d && v(d, e))
												? -1
												: t == x || (t.ownerDocument == d && v(d, t))
												? 1
												: l
												? P(l, e) - P(l, t)
												: 0
			...
			return (
				...
				ue(function (e, t, n, i) {
					var r,
						...
						d = m ? (v || (e ? h : u || g) ? [] : t) : f;
					if ((m && m(f, d, n, i), g))
						for (r = Ee(d, l), g(r, [], n, i), o = r.length; o--; )
							(s = r[o]) && (d[l[o]] = !(f[l[o]] = s));
					if (e) {
						if (v || h) {
							if (v) {
	...
	function be(e, t, n, i, r) {
		...
		for (f.textContent = "", h = 0; (o = d[h++]); )
			if (i && -1 < C.inArray(o, i)) r && r.push(o);
				...
				((u = re(o)), (s = ge(f.appendChild(o), "script")), u && ve(s), n)
			)
		...
		special: {
			...
			click: {
				setup: function (e) {
					var t = this || e;
					return (
						de.test(t.type) && t.click && D(t, "input") && De(t, "click", xe),
						!1
					);
				},
				trigger: function (e) {
					var t = this || e;
					return (
						de.test(t.type) && t.click && D(t, "input") && De(t, "click"), !0
					);
				},
				_default: function (e) {
					var t = e.target;
	...
	function Pe(n, i, r, o) {
		...
		var e,
			...
			h = i[0],
			p = y(h);
		if (p || (1 < f && "string" == typeof h && !v.checkClone && ke.test(h)))
		...
		if (
			...
			for (a = (s = C.map(ge(e, "script"), je)).length; c < f; c++)
				(l = e),
					c !== d &&
						((l = C.clone(l, !0, !0)), a && C.merge(s, ge(l, "script"))),
					r.call(n[c], l, c);
			if (a)
					...
					(l = s[c]),
						pe.test(l.type || "") &&
							...
							(l.src && "module" !== (l.type || "").toLowerCase()
								...
								: _(l.textContent.replace(Ae, ""), l, u));
		}
		return n;
	}
	function qe(e, t, n) {
	...
	function Ze(e, t, n) {
		...
		return (
			((!v.boxSizingReliable() && r) ||
				...
				(o = a in e) && (s = e[a])),
			(s = parseFloat(s) || 0) +
				Je(e, t, n || (r ? "border" : "content"), o, i, s) +
				"px"
		);
	}
		...
		style: function (e, t, n, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var r,
					...
					u = e.style;
				if (
					(l || (t = ze(a)), (s = C.cssHooks[t] || C.cssHooks[a]), void 0 === n)
				)
			...
			_default: {
				...
				set: function (e) {
					C.fx.step[e.prop]
						? C.fx.step[e.prop](e)
						: 1 !== e.elem.nodeType ||
						  (!C.cssHooks[e.prop] && null == e.elem.style[ze(e.prop)])
						? (e.elem[e.prop] = e.now)
	...
	function ft(o, e, t) {
		...
		for (
			...
			if ((n = ft.prefilters[i].call(u, o, c, u.opts)))
				return (
					y(n.stop) &&
	...
	(C.Animation = C.extend(ft, {
				...
				if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(h))
					...
					h))
						l ||
							...
							m && ue([e], !0),
							d.done(function () {
								for (i in (m || ue([e]), Y.remove(e, "fxshow"), h))
									C.style(e, i, h[i]);
							})),
							(l = ct(m ? g[i] : 0, i, d)),
							i in g ||
			...
			stop: function (r, e, o) {
				...
				return (
					...
					this.each(function () {
						...
						else for (t in i) i[t] && i[t].stop && st.test(t) && s(i[t]);
						for (t = n.length; t--; )
							n[t].elem !== this ||
								(null != r && n[t].queue !== r) ||
		...
		(it = T.createElement("input")),
		(rt = T.createElement("select").appendChild(T.createElement("option"))),
		(it.type = "checkbox"),
		(v.checkOn = "" !== it.value),
		(v.optSelected = rt.selected),
		((it = T.createElement("input")).value = "t"),
		(it.type = "radio"),
		...
		C.fn.extend({
			...
			toggleClass: function (r, t) {
				...
				return "boolean" == typeof t && s
					...
					: this.each(function () {
							var e, t, n, i;
							if (s)
								for (t = 0, n = C(this), i = yt(r); (e = i[t++]); )
									n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
							else
								(void 0 !== r && "boolean" !== o) ||
									((e = vt(this)) && Y.set(this, "__className__", e),
									this.setAttribute &&
										this.setAttribute(
											"class",
			...
			hasClass: function (e) {
				var t,
					...
					i = 0;
				for (t = " " + e + " "; (n = this[i++]); )
					if (1 === n.nodeType && -1 < (" " + gt(vt(n)) + " ").indexOf(t))
						return !0;
				return !1;
			},
		});
	...
	C.extend(C.event, {
		trigger: function (e, t, n, i) {
			...
			if (
				...
				3 !== n.nodeType &&
					8 !== n.nodeType &&
					!_t.test(h + C.event.triggered) &&
					(-1 < h.indexOf(".") && ((h = (p = h.split(".")).shift()), p.sort()),
					(l = h.indexOf(":") < 0 && "on" + h),
					((e = e[C.expando]
						? e
						: new C.Event(h, "object" == typeof e && e)).isTrigger = i ? 2 : 3),
					(e.namespace = p.join(".")),
				...
				if (!i && !c.noBubble && !b(n)) {
					for (
						a = c.delegateType || h, _t.test(a + h) || (o = o.parentNode);
						o;
						o = o.parentNode
					)
						d.push(o), (s = o);
					s === (n.ownerDocument || T) &&
						d.push(s.defaultView || s.parentWindow || x);
				}
				...
				return (
					...
					i ||
						...
						(l &&
							...
							((s = n[l]) && (n[l] = null),
							(C.event.triggered = h),
							e.isPropagationStopped() && f.addEventListener(h, wt),
							n[h](),
							e.isPropagationStopped() && f.removeEventListener(h, wt),
			...
			ajax: function (e, t) {
				...
				g.hasContent
					? g.data &&
					  ...
					  (g.data = g.data.replace(At, "+"))
					: ((o = g.url.slice(f.length)),
					  g.data &&
							(g.processData || "string" == typeof g.data) &&
							((f += (Tt.test(f) ? "&" : "?") + g.data), delete g.data),
					  !1 === g.cache &&
							((f = f.replace(jt, "$1")),
							(o = (Tt.test(f) ? "&" : "?") + "_=" + xt.guid++ + o)),
					  (g.url = f + o)),
				g.ifModified &&
					(C.lastModified[f] &&
				...
				if (
					...
					if (((E.readyState = 1), m && y.trigger("ajaxSend", [E, g]), p))
						return E;
					g.async &&
						0 < g.timeout &&
				...
				function u(e, t, n, i) {
					...
					p ||
						...
						!r &&
							-1 < C.inArray("script", g.dataTypes) &&
	...
	C.ajaxSetup({
		...
		C.each(["top", "left"], function (e, n) {
			C.cssHooks[n] = We(v.pixelPosition, function (e, t) {
				if (t)
					return (t = Be(e, n)), He.test(t) ? C(e).position()[n] + "px" : t;
			});
		}),
		...
		function d(e, t, n, i) {
			...
			if ("viewport" === i)
				(o = (r = d).ownerDocument.documentElement),
					(s = D(r, o)),
					(a = H(o.clientWidth, window.innerWidth || 0)),
					(l = H(o.clientHeight, window.innerHeight || 0)),
					(u = x(o)),
					(c = x(o, "left")),
					(f = C({
				...
				var h;
				"scrollParent" === i
					? "BODY" === (h = b(y(t))).nodeName &&
					  (h = e.ownerDocument.documentElement)
					: (h = "window" === i ? e.ownerDocument.documentElement : i);
				var p = D(h, d);
				if (
					"HTML" !== h.nodeName ||
					(function e(t) {
								...
								_.forEach(function (e, t) {
									...
									(s || f || h) &&
										...
										(p.offsets.popper = Q(
											{},
											p.offsets.popper,
											A(p.instance.popper, p.offsets.reference, p.placement)
										)),
										(p = j(p.instance.modifiers, p, "flip")));
								}),
								p
							);
						},
	...
	(function (e, t) {
							...
							if (i) {
								...
								e &&
									(("checkbox" !== i.type && "radio" !== i.type) ||
										(i.checked = !this._element.classList.contains(g)),
									p(i).trigger("change")),
									i.focus(),
									(t = !1);
							}
				...
				return (
					...
					(e._addTouchEventListeners = function () {
						...
						if (this._touchSupported) {
							var t = function (e) {
									n._pointerEvent &&
									O[e.originalEvent.pointerType.toUpperCase()]
		...
		p(document).on(
			...
			(p.fn[_] = j._jQueryInterface),
			(p.fn[_].Constructor = j),
		...
		var L = "collapse",
			...
			U = (function () {
				...
				return (
					...
					(e.show = function () {
						...
						if (
							...
							if ((p(this._element).trigger(i), !i.isDefaultPrevented())) {
								...
								p(this._element).removeClass(F).addClass(M),
								...
								p(this._element)
									.one(m.TRANSITION_END, function () {
										p(n._element)
											...
											p(n._element).trigger("shown.bs.collapse");
									})
					...
					(e._getConfig = function (e) {
						return (
							((e = l(l({}, q), e)).toggle = Boolean(e.toggle)),
							m.typeCheckConfig(L, e, H),
							e
						);
					}),
		...
		p(document).on("click.bs.collapse.data-api", W, function (e) {
			...
			(p.fn[L] = U._jQueryInterface),
			(p.fn[L].Constructor = U),
		...
		function Ee(e, n, t) {
			return (
				(void 0 === t
					...
					e.enabled &&
						V(t) &&
						((n.offsets.popper = fe(n.offsets.popper)),
						(n.offsets.reference = fe(n.offsets.reference)),
						(n = t(n, e)));
				}),
				n
			);
		...
		function Se(e, t, n, i) {
			(n.updateBound = i),
				Ce(e).addEventListener("resize", n.updateBound, { passive: !0 });
			var r = K(e);
			return (
				(function e(t, n, i, r) {
					var o = "BODY" === t.nodeName,
				...
				modifiers: {
								...
								E.forEach(function (e, t) {
									...
									(s || f || m) &&
										...
										(g.offsets.popper = ce(
											{},
											g.offsets.popper,
											_e(g.instance.popper, g.offsets.reference, g.placement)
										)),
										(g = Ee(g.instance.modifiers, g, "flip")));
								}),
								g
							);
						},
					...
					computeStyle: {
						...
						fn: function (e, t) {
							...
							var s,
								...
								T =
									((s = e),
									(a = window.devicePixelRatio < 2 || !Ae),
									(l = s.offsets),
									(u = l.popper),
									(c = l.reference),
									(f = Math.round),
									...
									(b = a ? f : h),
									{
										left: (y = a ? (g || v || p % 2 == m % 2 ? f : d) : h)(
											p % 2 == 1 && m % 2 == 1 && !v && a ? u.left - 1 : u.left
										),
										top: b(u.top),
										bottom: b(u.bottom),
										right: y(u.right),
							...
							if (
								((k =
									"bottom" === C
										? "HTML" === w.nodeName
											? -w.clientHeight + T.bottom
											: -E.height + T.bottom
										: T.top),
								(N =
									"right" === S
										? "HTML" === w.nodeName
											? -w.clientWidth + T.right
											: -E.width + T.right
										: T.left),
								_ && D)
							)
								(x[D] = "translate3d(" + N + "px, " + k + "px, 0)"),
									(x[C] = 0),
									(x[S] = 0),
							...
							var j = { "x-placement": e.placement };
							return (
								(e.attributes = ce({}, j, e.attributes)),
								(e.styles = ce({}, x, e.styles)),
					...
					applyStyle: {
						...
						onLoad: function (e, t, n, i, r) {
							...
							return (
								t.setAttribute("x-placement", s),
								ke(t, { position: n.positionFixed ? "fixed" : "absolute" }),
								n
							);
						},
						gpuAcceleration: void 0,
			...
			Me = (function () {
				function o(e, t) {
					...
					!(function (e, t) {
						...
						(this.popper = t && t.jquery ? t[0] : t),
						(this.options.modifiers = {}),
						Object.keys(ce({}, o.Defaults.modifiers, i.modifiers)).forEach(
							function (e) {
		...
		(Me.Utils = ("undefined" != typeof window ? window : global).PopperUtils),
			(Me.placements = je),
			(Me.Defaults = Fe);
		var Be = "dropdown",
			We = "bs.dropdown",
			...
			rt = (function () {
				...
				return (
						...
						if (
							...
							if ((p(i).trigger(n), !n.isDefaultPrevented())) {
								...
								"ontouchstart" in document.documentElement &&
									...
									p(i).toggleClass(Je).trigger(p.Event("shown.bs.dropdown", t));
							}
						}
					}),
					(e.hide = function () {
						if (
							...
							p(n).trigger(t),
								t.isDefaultPrevented() ||
									...
									p(this._menu).toggleClass(Je),
									p(n).toggleClass(Je).trigger(p.Event(Xe, e)));
						}
					}),
					(e.dispose = function () {
						p.removeData(this._element, We),
					...
					(e._getPlacement = function () {
						...
						return (
							e.hasClass("dropup")
								? (t = p(this._menu).hasClass(Ze) ? "top-end" : "top-start")
								: e.hasClass("dropright")
								? (t = "right-start")
								: e.hasClass("dropleft")
								? (t = "left-start")
								: p(this._menu).hasClass(Ze) && (t = "bottom-end"),
							t
						);
					}),
									...
									if (
										...
										p(r).trigger(l),
											l.isDefaultPrevented() ||
												...
												p(a).removeClass(Je),
												p(r).removeClass(Je).trigger(p.Event(Xe, s)));
									}
								}
							}
					}),
						...
						if (
							...
							if (n || 27 !== e.which) {
								if (
									...
									return (
										27 === e.which && p(t.querySelector(et)).trigger("focus"),
		...
		p(document)
			.on(Ke, et, rt._dataApiKeydownHandler)
			.on(Ke, tt, rt._dataApiKeydownHandler)
			.on(Ye + " keyup.bs.dropdown.data-api", rt._clearMenus)
			.on(Ye, et, function (e) {
				e.preventDefault(),
					e.stopPropagation(),
					rt._jQueryInterface.call(p(this), "toggle");
			})
			.on(Ye, ".dropdown form", function (e) {
				e.stopPropagation();
			}),
			(p.fn[Be] = rt._jQueryInterface),
			(p.fn[Be].Constructor = rt),
				...
				return (
					...
					(e.show = function (e) {
						...
						if (!this._isShown && !this._isTransitioning) {
							...
							var n = p.Event(dt, { relatedTarget: e });
						...
						if (
							...
							if (
								...
								if (
									...
									this._setResizeEvent(),
									p(document).off(ht),
									p(this._element).removeClass(_t),
									p(this._element).off(mt),
									p(this._dialog).off(vt),
									i)
								) {
					...
					(e._setEscapeEvent = function () {
						var t = this;
						this._isShown
							? p(this._element).on(gt, function (e) {
					...
					(e._hideModal = function () {
						...
						(this._element.style.display = "none"),
							...
							(this._isTransitioning = !1),
							this._showBackdrop(function () {
								p(document.body).removeClass(yt),
									e._resetAdjustments(),
									e._resetScrollbar(),
					...
					(e._showBackdrop = function (e) {
						...
						if (this._isShown && this._config.backdrop) {
							if (
								...
								p(this._element).on(mt, function (e) {
					...
					(r._jQueryInterface = function (n, i) {
						return this.each(function () {
							...
							if (
								(e || ((e = new r(this, t)), p(this).data(st, e)),
								"string" == typeof n)
							) {
								if (void 0 === e[n])
									throw new TypeError('No method named "' + n + '"');
		...
		p(document).on(
			...
			(p.fn[ot] = Tt._jQueryInterface),
			(p.fn[ot].Constructor = Tt),
						...
						r.forEach(function (e) {
							(function (e, t) {
								...
								if (-1 !== t.indexOf(n))
									return (
										-1 === Ct.indexOf(n) ||
										Boolean(e.nodeValue.match(Dt) || e.nodeValue.match(Nt))
									);
								for (
				...
				return (
					...
					(e.toggle = function (e) {
						if (this._isEnabled)
							if (e) {
								...
								if (p(this.getTipElement()).hasClass(Ut))
					...
					(e.show = function () {
						...
						if (this.isWithContent() && this._isEnabled) {
							...
							r.setAttribute("id", o),
								...
								this.setContent(),
								this.config.animation && p(r).addClass(Wt);
							var s =
					...
					(e.setContent = function () {
						...
						this.setElementContent(
							...
							p(e).removeClass(Wt + " " + Ut);
					}),
					(e.setElementContent = function (e, t) {
						"object" != typeof t || (!t.nodeType && !t.jquery)
							? this.config.html
								? (this.config.sanitize &&
										(t = kt(t, this.config.whiteList, this.config.sanitizeFn)),
								  e.html(t))
								: e.text(t)
							: this.config.html
					...
					(e._enter = function (e, t) {
						...
						(t = t || p(e.currentTarget).data(n)) ||
							...
							e && (t._activeTrigger["focusin" === e.type ? $t : Qt] = !0),
							p(t.getTipElement()).hasClass(Ut) || t._hoverState === Mt
								? (t._hoverState = Mt)
					...
					(e._leave = function (e, t) {
						...
						(t = t || p(e.currentTarget).data(n)) ||
							...
							p(e.currentTarget).data(n, t)),
							e && (t._activeTrigger["focusout" === e.type ? $t : Qt] = !1),
					...
					(e._getConfig = function (e) {
						...
						return (
							...
							e.sanitize &&
								(e.template = kt(e.template, e.whiteList, e.sanitizeFn)),
							e
						);
					}),
					...
					(i._jQueryInterface = function (n) {
						return this.each(function () {
							...
							if (
								...
								(e || ((e = new i(this, t)), p(this).data(Ot, e)),
								"string" == typeof n)
							) {
								if (void 0 === e[n])
									throw new TypeError('No method named "' + n + '"');
		...
		(p.fn[At] = zt._jQueryInterface),
			(p.fn[At].Constructor = zt),
				...
				return (
					...
					(i._jQueryInterface = function (n) {
						return this.each(function () {
							...
							if (
								(e || !/dispose|hide/.test(n)) &&
								(e || ((e = new i(this, t)), p(this).data(Xt, e)),
								"string" == typeof n)
							) {
								if (void 0 === e[n])
									throw new TypeError('No method named "' + n + '"');
		...
		(p.fn[Vt] = nn._jQueryInterface),
			(p.fn[Vt].Constructor = nn),
		...
		var rn = "scrollspy",
			...
			un = { offset: "number", method: "string", target: "(string|element)" },
			cn = "active",
			fn = ".nav, .list-group",
			dn = ".nav-link",
			hn = ".list-group-item",
			...
			mn = (function () {
				...
				return (
					...
					(e.dispose = function () {
						p.removeData(this._element, on),
							p(this._scrollElement).off(sn),
							(this._element = null),
					...
					(e._getConfig = function (e) {
						if (
							"string" !=
								typeof (e = l(l({}, ln), "object" == typeof e && e ? e : {}))
									.target &&
							m.isElement(e.target)
						) {
							var t = p(e.target).attr("id");
							t || ((t = m.getUID(rn)), p(e.target).attr("id", t)),
								(e.target = "#" + t);
						}
						...
						n.hasClass("dropdown-item")
							...
							: (n.addClass(cn),
							  n
									...
									.prev(dn + ", " + hn)
									.addClass(cn),
							  n.parents(fn).prev(".nav-item").children(dn).addClass(cn)),
		...
		p(window).on("load.bs.scrollspy.data-api", function () {
			...
			(p.fn[rn] = mn._jQueryInterface),
			(p.fn[rn].Constructor = mn),
					...
					(i._jQueryInterface = function (n) {
						return this.each(function () {
							var e = p(this),
								t = e.data(gn);
							if (
								(t || ((t = new i(this)), e.data(gn, t)), "string" == typeof n)
							) {
								if (void 0 === t[n])
									throw new TypeError('No method named "' + n + '"');
								t[n]();
		...
		p(document).on(
			...
			(p.fn.tab = wn._jQueryInterface),
			(p.fn.tab.Constructor = wn),
				...
				return (
						...
						var e = this,
							t = function () {
								e._element.classList.add("hide"),
									p(e._element).trigger("hidden.bs.toast");
							};
					...
					(i._jQueryInterface = function (n) {
						return this.each(function () {
							...
							if (
								(t ||
									((t = new i(this, "object" == typeof n && n)), e.data(xn, t)),
								"string" == typeof n)
							) {
								if (void 0 === t[n])
									throw new TypeError('No method named "' + n + '"');
		...
		(p.fn[En] = On._jQueryInterface),
			(p.fn[En].Constructor = On),
